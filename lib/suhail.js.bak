...
let yt = {
  ...
  download: async (_0x1ea0cb, _0x5c75ae = {
    ...
    try {
      ...
      let _0x3991fc = "./temp/Suhail-Md " + _0x1ea0cb + '.' + _0x35b4d2;
  ...
  try {
    ...
    exec("ffmpeg -i " + _0x25e2bd + " " + _0x3497f6 + " " + _0x58830b, async (_0x43e1ec, _0x22acc9, _0x3cea68) => {
      ...
      if (_0x43e1ec) {
        ...
        ;
        var _0xfba2a2 = {
          ...(await _0x1ef339.bot.contextInfo("Hello " + _0x1ef339.senderName + " 🤍", "⇆ㅤ ||◁ㅤ❚❚ㅤ▷||ㅤ ⇆"))
        };
                                                                      ...
                                                                      if (_0x2d4089.toLowerCase() === "nicole" || _0x2d4089 === '33') {
                                                                        ...
                                                                        if (_0x2d4089.toLowerCase() === "jessie" || _0x2d4089 === '34') {
                                                                          ...
                                                                          if (_0x2d4089.toLowerCase() === "ryan" || _0x2d4089 === '35') {
                                                                            ...
                                                                            if (_0x2d4089.toLowerCase() === "suhail" || _0x2d4089 === '36') {
                                                                              _0x30713a = 0x23;
                                                                            } else {
      ...
      for (const _0x55bb42 of _0x55b13f) {
        ...
        if (_0x1cf682.length >= 0x1) {
          ...
          if (_0x243ab6 !== -0x1) {
            ...
            let _0x192321 = /suhail|smd|message|chat/gi.test(_0xef10c6);
            if (!_0x4656bb[_0x192321 ? "suhail" : _0xef10c6]) {
              _0x4656bb[_0x192321 ? "suhail" : _0xef10c6] = [];
            }
          }
          const _0x26ebaf = _0x1cf682.filter(_0x1fa91c => _0x1fa91c !== "type/" + _0xef10c6 && _0x1fa91c !== '');
          _0xef10c6 = /suhail|smd|message|chat/gi.test(_0xef10c6) ? "suhail" : _0xef10c6;
          if (_0x26ebaf.length > 0x0) {
            if (_0x22e9cc.includes(_0xef10c6)) {
              ...
              _0x4656bb[/suhail/gi.test(_0xef10c6) ? 'suhail' : 'text'].push(_0x26ebaf.join(" "));
            }
          }
        }
        _0xef10c6 = null;
...
setMention.check = async (_0x373988, _0x3c756b = '', _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes('@' + _0x373988.user.split('@')[0x0]) || global.mentionsuhail && (_0x373988.mentionedJid.includes("@923184474176@s.whatsapp.net") || _0x373988.mentionedJid.includes("@923004591719@s.whatsapp.net") || /@923184474176|@923004591719/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.SmdOfficial !== "yes") {
        return;
      }
