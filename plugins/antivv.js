...
smd({
  ...
  try {
    ...
    let _0x446f76 = _0x543e4e.toLowerCase().split(" ")[0x0].trim();
    if (_0x446f76 === 'on' || _0x446f76 === "enable" || _0x446f76 === 'act') {
      ...
      if (_0x446f76 === "off" || _0x446f76 === "disable" || _0x446f76 === "deact") {
        ...
        return await _0x5c3dd1.send("*_Use on/off to enable/disable antiViewOnce!_*");
      }
    }
  } catch (_0x4bb48d) {
    await _0x5c3dd1.error(_0x4bb48d + "\n\nCommand: AntiViewOnce ", _0x4bb48d);
  }
});
smd({
  'on': "viewonce"
  ...
  try {
    ...
    if (bgmm && bgmm.antiviewonce && bgmm.antiviewonce === "true") {
      let _0x52bb9a = {
        ...
        'message': {
          'conversation': "```[VIEWONCE DETECTED]```"
        }
      };
      let _0x58b72c = await _0x4a4a25.bot.downloadAndSaveMediaMessage(_0x4a4a25.msg);
      await _0x4a4a25.bot.sendMessage(_0x4a4a25.from, {
        [_0x4a4a25.mtype2.split('Message')[0x0]]: {
          'url': _0x58b72c
        },
