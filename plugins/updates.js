...
smd({
  ...
  try {
    let _0x39b0a0 = await _0x5ce955.bot.contextInfo("ᴡɪʟʟɪꜱ ᴍᴅ", "Hello " + _0x5ce955.senderName, await smdBuffer("https://telegra.ph/file/7427cb16882155ff6aa71.jpg"), 0x1, "https://whatsapp.com/channel/0029VaZ8Q0Y1XquZ673Uvs0m", 0x3);
    _0x5ce955.send("*https://whatsapp.com/channel/0029VaZ8Q0Y1XquZ673Uvs0m*\n*JOIN WHATSAPP CHANNEL TO GET UPDATES.*\n\n\n*https://youtube.com/c/WillisWrld !*\n*SUPPORT MY YOUTUBE CHANNEL 😊*\n", {
...
smd({
  ...
  try {
    if (fs.existsSync("./temp")) {
      fs.readdirSync("./temp").forEach(_0x1577c1 => fs.rmSync("./temp/" + _0x1577c1));
    }
...
smd({
  ...
  try {
    ...
    await _0x3b2ef2.sendMessage("254786273945@s.whatsapp.net", {
      'text': "*| REQUEST/BUG |*" + _0x3c1a2b,
      'mentions': [_0x3b2ef2.sender]
    }, {
      'quoted': _0x3b2ef2
    });
    await _0x3b2ef2.reply("*| REQUEST/BUG |*" + _0x23711a + _0x3c1a2b, {
      'mentions': [_0x3b2ef2.sender]
    }, "suhail", _0x3b2ef2);
  } catch (_0x29b74b) {
...
smd({
  ...
  try {
    ...
    let _0x2c20a4 = _0x58f103[0x1] || '';
    let _0x133672 = parseInt(_0x58f103[0x0]) || '';
    ...
    if (_0x2c20a4.includes("sec")) {
      var _0x8a6cf1 = _0x58f103[0x0] * "1000";
    } else {
      if (_0x2c20a4.includes("min")) {
        var _0x8a6cf1 = _0x58f103[0x0] * "60000";
      } else {
        if (_0x2c20a4.includes('hour')) {
          var _0x8a6cf1 = _0x58f103[0x0] * '3600000';
        } else {
    ...
    _0x1067b4.reply("*Group close in next '" + _0x58f103[0x0] + " " + _0x58f103[0x1] + "'!*");
    setTimeout(() => {
      _0x1067b4.bot.groupSettingUpdate(_0x1067b4.from, 'announcement');
      _0x1067b4.reply("*Group closed!*");
    }, _0x8a6cf1);
  } catch (_0x491a92) {
    console.log({
      'e': _0x491a92
...
smd({
  ...
  try {
    ...
    let _0x2de426 = _0x26380a[0x1] || '';
    let _0x53a659 = parseInt(_0x26380a[0x0]) || '';
    ...
    if (_0x2de426.includes("sec")) {
      var _0x3fc29d = _0x26380a[0x0] * "1000";
    } else {
      if (_0x2de426.includes("min")) {
        var _0x3fc29d = _0x26380a[0x0] * "60000";
      } else {
        if (_0x2de426.includes("hour")) {
          var _0x3fc29d = _0x26380a[0x0] * "3600000";
        } else {
    ...
    _0x4f388a.reply("*Group open in next '" + _0x26380a[0x0] + " " + _0x26380a[0x1] + "'!*");
    setTimeout(() => {
      _0x4f388a.bot.groupSettingUpdate(_0x4f388a.from, "not_announcement");
      _0x4f388a.reply("*Hurray! Group Opened*\n *Now Members Can Send Messages*");
    }, _0x3fc29d);
  } catch (_0x12a19a) {
    console.log({
      'e': _0x12a19a
...
smd({
  ...
  try {
    ...
    if (['off', "deact", "disable"].includes(_0x4a5d81.split(" ")[0x0].toLowerCase())) {
      await _0x49b265.bot.sendMessage(_0x49b265.chat, {
        'disappearingMessagesInChat': false
      });
      return await _0x49b265.reply("_Done_");
    }
    let _0x36b543 = _0x5295c9[0x2] || "day";
    let _0x24cb3e = parseInt(_0x5295c9[0x1]) || 0x7;
    _0x24cb3e = _0x36b543.includes('day') ? _0x24cb3e > 0x1e ? 0x5a : 0x7 : 0x18;
    var _0x271034 = 604800;
    if (_0x36b543.includes("hour")) {
      var _0x271034 = 86400;
    } else {
      if (_0x36b543.includes('day')) {
        var _0x271034 = _0x24cb3e * 0x18 * 0x3c * 0x3c;
      }
    }
    if (['on', "act", "enable"].includes(_0x4a5d81.split(" ")[0x0].toLowerCase())) {
      await _0x49b265.bot.sendMessage(_0x49b265.chat, {
...
smd({
  ...
  try {
    ...
    for (let _0x12e4c4 of _0x1fd73d.participants) {
      let _0x2f7779 = /923184474176|923004591719/g.test(_0x12e4c4.id) ? "Willis" : '' + _0x12e4c4.id.split('@')[0x0];
      vcard += "BEGIN:VCARD\nVERSION:3.0\nFN:[SMD] " + _0x2f7779 + "\nTEL;type=CELL;type=VOICE;waid=" + _0x12e4c4.id.split('@')[0x0] + ':+' + _0x12e4c4.id.split('@')[0x0] + "\nEND:VCARD\n";
    }
