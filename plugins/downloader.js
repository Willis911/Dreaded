...
smd({
  ...
  try {
    ...
    let _0x2a4fb1 = _0x155c01.split('|')[0x0];
    let _0x27aa70 = _0x2a4fb1.split("/addstickers/")[0x1];
    let {
      result: _0x4a601d
    ...
    let _0x54b45a = _0x155c01.split('|')[0x1] || '';
    ...
    if (_0x4a601d.is_animated) {
      ...
      if (_0x54b45a.startsWith("info")) {
        return await _0x19df48.reply(_0x56bec3);
      }
    }
    let _0x26c3a3 = parseInt(_0x54b45a.split(',')[0x0]) || 0xa;
    let _0x33784b = parseInt(_0x54b45a.split(',')[0x1]) || 0x0;
    let _0x4cca92 = _0x54b45a.split(';')[0x1] || "Sticker";
    let _0x3a6ece = true;
    ...
    if (_0x33784b > _0x4a601d.stickers.length) {
      _0x33784b = _0x4a601d.stickers.length - 0x5;
    }
    ...
    for (_0x33784b; _0x33784b < _0x26c3a3; _0x33784b++) {
      ...
      if (_0x3a6ece) {
        ...
        await _0x19df48.bot.sendMessage(_0x19df48.chat, {
          ...
          'caption': "*_Telegram Sticker At Index " + (_0x33784b + 0x1) + " Downloaded_*"
        });
      }
    }
  } catch (_0x5a840a) {
...
smd({
  ...
  try {
    ...
    if (!_0x6c377e || !_0x6c377e[0x0]) {
      return await _0x47fb55.send("*_No Results Found!_*");
    }
    let _0xc4fe0 = _0x47fb55.iscreator && _0x5614e8.split('|')[0x1] === "all" ? _0x6c377e.length : _0x6c377e.length > 0x5 ? 0x5 : _0x6c377e.length;
    for (let _0xfe1387 = 0x0; _0xfe1387 < _0xc4fe0; _0xfe1387++) {
      try {
...
smd({
  ...
  try {
    ...
    return await _0x3a3af2.bot.sendMessage(_0x3a3af2.chat, {
      'video': {
        'url': _0x3f4693.result.urls[0x0].url
      },
...
cmd({
  ...
  try {
    ...
    if (_0x4ac8f2.length) {
      let _0x3d85b = await download(_0x4ac8f2[0x0].id);
      let _0x307e6f = "*ᴡɪʟʟɪꜱ-ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ* \n*________________________________* \n\n*_Reply Any Number To Download._*\n_Results For : " + _0x1cb962 + "_ \n";
      for (let _0x5a5920 = 0x0; _0x5a5920 < _0x4ac8f2.length; _0x5a5920++) {
        _0x307e6f += "\n*" + (_0x5a5920 + 0x1) + " : " + _0x4ac8f2[_0x5a5920].name + "* \n*Id : " + _0x4ac8f2[_0x5a5920].id + "* \n";
      }
...
smd({
  ...
  try {
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url, _.gitclone https://github.com/WillisKE/Suhail_*");
    }
    if (!/(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i.test(_0x1c586e)) {
      return await _0x1ae8f8.reply("*Provide Valid Repositry Url*");
    }
    let [_0x3b1b37, _0x2f1dcc, _0x83a6d7] = _0x1c586e.match(/(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i) || [];
...
smd({
  ...
  'category': "downloader",
  'filename': __filename,
  'use': "<Hii,this is Willis>"
}, async (_0x55aba2, _0x56da6b) => {
  try {
    let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
    if (!_0x204f81) {
      return _0x55aba2.reply("*_Example : .tts Hi,I am Willis-Md whatsapp bot._*");
    }
    try {
      let _0x1974d5 = _0x56da6b ? _0x56da6b.split(" ")[0x0].toLowerCase() : 'en';
...
smd({
  'pattern': "downmp4",
  'alias': ['mp4down', "mp4fromurl","videofromurl","fromurl"],
  ...
  try {
    let _0x53783b = ('' + (_0x3c482f ? _0x3c482f : _0x272f8d.reply_text)).split(" ")[0x0].toLowerCase().trim();
...
smd({
  ...
  if (!_0x54713e) {
    return _0xe5ea97.reply("*Use : " + prefix + "video Prince Indahh*");
  }
  let _0x421809 = /(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/.exec(_0x36bc71) || [];
  let _0x35c755 = _0x421809[0x0] || false;
  try {
    if (!_0x35c755) {
      let _0x588f03 = await yts(_0x54713e);
      let _0x525771 = _0x588f03.videos[0x0];
      _0x35c755 = _0x525771.url;
      _0x421809 = /(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/.exec(_0x35c755);
    }
  } catch {}
  try {
    let _0x1df0ed = await ytdl.getInfo(_0x35c755);
    let _0x5c8a7c = Math.floor(i.timestamp * 0x3c);
    if (_0x5c8a7c >= 8000 {
      _0x5b10f0 = "document";
    }
    let _0x56042a = _0x1df0ed.videoDetails.title;
    let _0x5d70e6 = "./temp/" + _0x421809[0x1] + ".mp4";
    const _0x4195ce = ytdl(_0x35c755, {
      'filter': _0x4f303f => _0x4f303f.itag == 0x16 || _0x4f303f.itag == 0x12
    ...
    try {
      let _0x4e4465 = await yt.getInfo(_0x421809[0x1]);
      if (_0x4e4465.duration >= 8000 {
        _0x5b10f0 = "document";
      }
      let _0x3d6d42 = {
        'type': "video",
      ...
      let _0x3448d2 = _0x4e4465.title || _0x3e3caf || _0x421809[0x1] || "ᴡɪʟʟɪꜱ ᴍᴅ -- ʏᴛ ᴠɪᴅᴇᴏ";
      if (_0x3e3caf) {
...
smd({
  ...
  let _0x45b86d = /(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/.exec(_0x5af7a0) || [];
  let _0x1b8dbb = _0x45b86d[0x0] || false;
  try {
    if (!_0x1b8dbb) {
      let _0x39917e = await yts(_0x51cced);
      let _0x4edc53 = _0x39917e.videos[0x0];
      _0x1b8dbb = _0x4edc53.url;
      _0x45b86d = /(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/.exec(_0x1b8dbb);
    }
  } catch {}
  try {
    let _0x158918 = await yt.getInfo(_0x45b86d[0x1]);
    let _0x355f66 = {
      'type': "video",
      'quality': _0x158918.pref_Quality || "best",
      'format': "mp4"
    };
    if (_0x158918.duration >= 8000 {
      _0x5cbfdb = 'document';
    }
    let _0x2b6ac2 = await yt.download(_0x45b86d[0x1], _0x355f66);
    let _0x10f021 = _0x158918.title || _0x2b6ac2 || _0x45b86d[0x1];
    var _0x1e7392 = {
...
smd({
  ...
  try {
    ...
    if (!_0x25d045) {
      return _0x54463e.reply('*' + prefix + "play Prince Indah Nyar Joluo*");
    }
    ...
    if (_0x6845ab && _0x6845ab.duration >= 8000 {
...
smd({
  ...
  try {
    ...
    if (_0x19c223.toString() == "NaN" || _0x19c223 < 0x1 || _0x19c223 > 0xa0) {
    ...
    let _0x4737bb = {
      'audio': _0x2ba501,
      'fileName': "Willis-Md tiktok Sound" + _0x19c223 + '.m4a',
      'mimetype': 'audio/mpeg',
      'ptt': true,
...
smd({
  ...
  try {
    ...
    let _0x149d79 = _0x3dfcd0 ? _0x3dfcd0.split(" ")[0x0] : '';
    ...
    try {
      ...
      let _0x44d97e = await smdJson(api_smd + "/api/musically?url=" + _0x149d79);
...
smd({
  ...
  try {
    ...
    let _0x5c9751 = {
      'audio': {
        'url': _0x5f35d4[0x0].audio
      },
      'caption': '*' + _0x5f35d4[0x0].title + '*',
      'fileName': _0x5f35d4[0x0].title + ".mp3",
      'mimetype': "audio/mpeg",
...
smd({
  ...
  try {
    ...
    if (!_0x383852 || !_0x383852[0x0]) {
      return await _0xf8b0b.send("*_No Result found!_*");
    }
    var _0x132d25 = {
      ...(await _0xf8b0b.bot.contextInfo(Config.botname, "ᴘɪɴᴛᴇʀᴇꜱᴛ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ"))
    };
    let _0x21ce53 = _0x383852.length < 0x5 ? _0x383852.length : 0x5;
    for (let _0x1af9e9 = 0x0; _0x1af9e9 < _0x21ce53; _0x1af9e9++) {
...
smd({
  ...
  try {
    ...
    let _0x4190c2 = _0x4ae56d.split(" ")[0x0];
    const _0x15a389 = await mediafire(_0x4190c2);
    if (!_0x15a389 || !_0x15a389[0x0]) {
      return _0x1ccf8b.reply("could not found anything");
    }
    let _0x504ec3 = "『 *Mᴇᴅɪᴀғɪʀᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ* 』\n\n *Name* : " + _0x15a389[0x0].nama + "\n *Size* :" + _0x15a389[0x0].size + "\n *Mime* : " + _0x15a389[0x0].mime + "\n \n\n" + Config.caption;
    _0x504ec3 = await fancytext(_0x504ec3, 0x19);
    var _0x227c35 = {
      ...(await _0x1ccf8b.bot.contextInfo(Config.botname, "MEDIAFIRE"))
    };
    let _0x33773c = {
      'document': {
        'url': _0x15a389[0x0].link
      },
      'caption': _0x504ec3,
      'fileName': _0x15a389[0x0].nama,
      'mimetype': _0x15a389[0x0].mime,
...
cmd({
  ...
  try {
    ...
    return await _0x1c8285.sendMessage(_0x1c8285.chat, {
      'image': {
        'url': _0x2878ec.all[0x0].thumbnail
      },
      'caption': _0x4186e4
    }, {
      'quoted': _0x1c8285
...
smd({
  ...
  const _0x4a3f32 = /(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/.exec(_0x2d4f04) || [];
  if (!_0x2d4f04 || !_0x4a3f32[0x0]) {
    return await _0x1d4717.reply("*_provide youtube video url!_*");
  }
  try {
    let _0x5c93a9 = await ytdl.getInfo(_0x4a3f32[0x0]);
    if (_0x5c93a9.videoDetails.lengthSeconds >= 8000 {
      _0x58ceb6 = "document";
    }
    let _0x1a3a4c = _0x5c93a9.videoDetails.title;
    let _0x1c86b6 = './temp/' + _0x4a3f32[0x1] + ".mp4";
    const _0x1f15ef = ytdl(_0x4a3f32[0x0], {
      'filter': _0x4c0ea7 => _0x4c0ea7.itag == 0x16 || _0x4c0ea7.itag == 0x12
    ...
    try {
      let _0x5a46ec = await yt.getInfo(_0x4a3f32[0x1]);
      let _0x257939 = {
        'type': "video",
        'quality': _0x5a46ec.pref_Quality || "best",
        'format': "mp4"
      };
      if (_0x5a46ec.duration >= 8000 {
        _0x58ceb6 = "document";
      }
      let _0x588c42 = await yt.download(_0x4a3f32[0x1], _0x257939);
      var _0x3b1bff = {
        ...(await _0x1d4717.bot.contextInfo(Config.botname, "ʏᴏᴜᴛᴜʙᴇ ᴠɪᴅᴇᴏ"))
      };
      let _0x13be6f = _0x5a46ec.title || _0x588c42 || _0x4a3f32[0x1];
      if (_0x588c42) {
...
smd({
  ...
  const _0x2758ec = /(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/.exec(_0x4fe91c) || [];
  if (!_0x4fe91c || !_0x2758ec[0x0]) {
    return await _0x3f8930.reply("*_Uhh please, Provide youtube video url!_*");
  }
  try {
    let _0x4b5067 = await ytdl.getInfo(_0x2758ec[0x0]);
    if (_0x4b5067.videoDetails.lengthSeconds >= 8000 {
      _0x540f68 = "document";
    }
    let _0xaca4bd = _0x4b5067.videoDetails.title;
    let _0x24816a = "./temp/" + _0x2758ec[0x1] + ".mp3";
    const _0x2591f0 = ytdl(_0x2758ec[0x0], {
      'filter': _0x4e89f2 => _0x4e89f2.audioBitrate == 0xa0 || _0x4e89f2.audioBitrate == 0x80
    ...
    try {
      let _0x5b9011 = await yt.download(_0x2758ec[0x1], {
        'type': "audio",
        'quality': "best"
      });
      var _0x29af08 = {
...
smd({
  ...
  try {
    ...
    const _0x1d542b = /(?:http(?:s|):\/\/|)(?:(?:www\.|)youtube(?:\-nocookie|)\.com\/(?:watch\?.*(?:|\&)v=|embed|shorts\/|v\/)|youtu\.be\/)([-_0-9A-Za-z]{11})/.exec(_0x5696a7) || [];
    if (!_0x5696a7 || !_0x1d542b[0x0]) {
      return await _0x17c662.reply("❌Please provide me a url");
    }
    var _0x43c5ac = _0x1d542b[0x1];
    var _0x59bbaa = false;
    try {
      let _0x32b31a = await ytdl.getInfo(_0x1d542b[0x0]);
      _0x43c5ac = _0x32b31a.videoDetails.title;
      let _0x4b47c3 = "./temp/Willis-Md " + _0x1d542b[0x1] + '.mp3';
      const _0x212389 = ytdl(_0x1d542b[0x0], {
        'filter': _0xd2371a => _0xd2371a.audioBitrate == 0xa0 || _0xd2371a.audioBitrate == 0x80
      ...
      try {
        _0x59bbaa = await yt.download(_0x1d542b[0x1], {
          'type': "audio",
          'quality': 'best'
        });
      } catch (_0x4122cc) {
    ...
    let _0x300d1a = {
      ...
      'mimetype': "audio/mpeg",
      'fileName': "Willis-Md--" + _0x1d542b[0x1] + '.mp3',
      'caption': Config.caption,
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0x0].includes("ᴡɪʟʟɪꜱ-ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
      ...
      try {
        ...
        if (_0xb75e78.text.startsWith('1')) {
          ...
          const _0x5e7871 = ytdl(_0x43a95e, {
            'filter': _0x145c7e => _0x145c7e.itag == 0x16 || _0x145c7e.itag == 0x12
      ...
      if (_0x5b8ee5[0x0].includes("ᴡɪʟʟɪꜱ-ᴍᴅ • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
        let _0x307bb6 = '*' + _0xb75e78.text.split(" ")[0x0] + " : ";
        const _0x56275d = _0x5b8ee5.find(_0x3b5e74 => _0x3b5e74.startsWith(_0x307bb6));
        if (_0x56275d) {
          try {
            let _0x3e1826 = _0x56275d.replace(_0x307bb6, '').split('*')[0x0].trim();
            const _0x4d9213 = _0x5b8ee5[_0x5b8ee5.indexOf(_0x56275d) + 0x1];
            const _0x37a579 = _0x4d9213.split('*')[0x1].replace("Url : ", '').trim();
            if (_0x37a579.startsWith("http")) {
              ...
              let _0x26cc84 = "./temp/Yts Download " + Math.floor(Math.random() * 0x2710) + '.mp4';
              const _0x104b4c = ytdl(_0x37a579, {
                'filter': _0x31a431 => _0x31a431.itag == 0x16 || _0x31a431.itag == 0x12
        ...
        if (_0x5b8ee5[0x0].includes("ᴡɪʟʟɪꜱ-ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
          let _0x35d668 = '*' + _0xb75e78.text.split(" ")[0x0] + " : ";
          const _0x205a5f = _0x5b8ee5.find(_0x304058 => _0x304058.startsWith(_0x35d668));
          if (_0x205a5f) {
            try {
              const _0x14618c = _0x5b8ee5[_0x5b8ee5.indexOf(_0x205a5f) + 0x1];
              const _0x2407a8 = _0x14618c.split('*')[0x1].replace("Id : ", '').trim();
              await _0xb75e78.sendMessage(_0xb75e78.chat, {
                'react': {
                  'text': '✨',
                  'key': _0xb75e78.key
...
smd({
  ...
  try {
    var _0x3ef119 = _0x45d2ef.toLowerCase().includes('doc') ? 'document' : _0x45d2ef.toLowerCase().includes("mp3") || _0x45d2ef.toLowerCase().includes("audio") ? "audio" : 'video';
    if (!_0x45d2ef || !_0x45d2ef.includes('=') || !/http/gi.test(_0x45d2ef)) {
      return await _0x1283e0.reply("*Use Playlist URL, Like: " + prefix + "playlist https://www.youtube.com/c/WillisWrld*");
    }
    let _0x1c2a7e = _0x45d2ef.split('=')[0x1].split(" ")[0x0];
    ...
    yts(_0x20ebc9, async function (_0x594f1f, _0x2548a3) {
      ...
      for (let _0x1492ac = 0x0; _0x1492ac < _0x2548a3.videos.length; _0x1492ac++) {
        ...
        try {
          ...
          if (_0x48a6df.videoDetails.lengthSeconds >= 0x7d0) {
            _0x3ef119 = 'document';
          }
          let _0x5ec28d = _0x48a6df.videoDetails.title;
          let _0x1a85a9 = '' + Math.floor(Math.random() * 0x2710) + ".mp4";
          const _0x55ba81 = ytdl(_0xdaf4e3, {
            'filter': _0x1df4a7 => _0x1df4a7.itag == 0x16 || _0x1df4a7.itag == 0x12
          ...
          if (_0x4a0671 <= 0x190) {
            let _0x3eab5e = {
              ...
              'fileName': '' + _0x5ec28d,
              'caption': _0x3ef119 == "document" ? '' : " ⿻ Title : " + _0x5ec28d + "\n ⿻ File Size : " + _0x4a0671 + "0MB",
              'headerType': 0x4,
              'contextInfo': {
                'externalAdReply': {
            ...
            _0x1283e0.reply("❌ File size bigger than 400mb.");
          }
          try {
