...
smd({
  ...
  try {
    if (!match) {
      return await message.send(`_*Example:-* .lastseen all_\n_to change last seen privacy settings_`);
    }
    const available_privacy = ['all', 'contacts', 'contact_blacklist', 'none'];
    if (!available_privacy.includes(match)) {
      return await message.send(`_action must be *${available_privacy.join(' / ')}* values_`);
    }
...
smd({
  ...
  try {
    if (!match) {
      return await message.send(`_*Example:-* .online all_\n_to change *online*  privacy settings_`);
    }
...
smd({
  ...
  try {
    if (!match) {
      return await message.send(`_*Example:-* .mypp all_\n_to change *profile picture*  privacy settings_`);
    }
    const available_privacy = ['all', 'contacts', 'contact_blacklist', 'none'];
    if (!available_privacy.includes(match)) {
      return await message.send(`_action must be *${available_privacy.join('/')}* values_`);
...
smd({
  ...
  try {
    if (!match) {
      return await message.send(`_*Example:-* .mystatus all_\n_to change *status*  privacy settings_`);
    }
    const available_privacy = ['all', 'contacts', 'contact_blacklist', 'none'];
    if (!available_privacy.includes(match)) {
      return await message.send(`_action must be *${available_privacy.join('/')}* values_`);
...
smd({
  ...
  try {
    if (!match) {
      return await message.send(`_*Example:-* .read all_\n_to change *read and receipts message*  privacy settings_`);
    }
...
smd({
  ...
  try {
    if (!match) {
      return await message.send(`_*Example:-* .groupadd all_\n_to change *group add*  privacy settings_`);
    }
    const available_privacy = ['all', 'contacts', 'contact_blacklist', 'none'];
    if (!available_privacy.includes(match)) {
      return await message.send(`_action must be *${available_privacy.join('/')}* values_`);
